...
const drawBullet = (n, x, y, a) => {
  ...
  switch (n) {
    ...
    case 1:
      ...
      break;
    default:
      ctx.font = `500 ${window.innerHeight / 25 * pixelRatio}px Metropolis`;
      ctx.fillStyle = "#F55";
      ctx.textAlign = "left";
...
const cntRender = () => {
  ...
  ctx.font = `700 ${window.innerHeight / 25 * pixelRatio}px Metropolis`;
  ctx.fillStyle = "#333";
  ctx.textAlign = "center";
  ctx.textBaseline = "top";
...
const calculateResult = () => {
  ...
  if (missPoint.length == 0) {
    missCtx.fillStyle = "#FFF";
    missCtx.font = `500 ${window.innerHeight / 30 * pixelRatio}px Metropolis`;
